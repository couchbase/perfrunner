...
[clusters]
datasource =
        azurerm.azurerm_cluster_1.azurerm_node_group_1.1:kv,n1ql,index
        azurerm.azurerm_cluster_1.azurerm_node_group_1.2:kv,n1ql,index
        azurerm.azurerm_cluster_1.azurerm_node_group_1.3:kv,n1ql,index
        azurerm.azurerm_cluster_1.azurerm_node_group_1.4:kv,n1ql,index
...
instance_type = Standard_E8ps_v6
instance_capacity = 4
volume_size = 4100
disk_tier = P60
iops = 16000
...
instance_type = Standard_D64as_v4
instance_capacity = 1
volume_size = 100
...
[parameters]
OS = Ubuntu 24
CPU = Data+Query+Index: Standard_E8ps_v6 (8 vCPU), Analytics: Standard_D8pds_v6 (8 vCPU)
Memory = Data+Index+Query: 64GB, Analytics: 32GB
Disk = Data+Index+Query: P60 Premium SSD 4100GB, Analytics: Local NVMe SSD 440GB
