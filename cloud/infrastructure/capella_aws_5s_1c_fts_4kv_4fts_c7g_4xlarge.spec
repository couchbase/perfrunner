...
couchbase1 =
    ...
    ec2.ec2_cluster_1.ec2_node_group_3.1:fts
    ec2.ec2_cluster_1.ec2_node_group_3.2:fts
    ec2.ec2_cluster_1.ec2_node_group_3.3:fts
    ec2.ec2_cluster_1.ec2_node_group_3.4:fts
...
[parameters]
cpu = Data: c7g.4xlarge (16 vCPU), FTS: c7g.4xlarge (16 vCPU)
memory = 32GB
