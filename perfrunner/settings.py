...
class DiagEvalSettings:
    ...
    def __init__(self, options: dict, enable_nonlocal_diag_eval: bool):
        ...
        self.payloads = options.get('payloads').strip().split('\n')
...
class TestConfig(Config):
    ...
    def diag_eval(self) -> DiagEvalSettings:
        ...
        diag_evals = self._get_options_as_dict('diag_eval')
        return DiagEvalSettings(diag_evals, enable_nonlocal_diag_eval)
