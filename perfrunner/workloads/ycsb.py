...
def ycsb_data_load(workload_settings: PhaseSettings,
    ...
    run_ycsb(
        ...
        findoneproportion=workload_settings.findoneproportion,
        aggregateproportion=workload_settings.aggregateproportion,
        aggregate_minoccurrences=workload_settings.aggregate_minoccurrences,
        typedfields=workload_settings.typedfields,
        nesteddata=workload_settings.nesteddata,
    )
...
def ycsb_workload(workload_settings: PhaseSettings,
    ...
    run_ycsb(
        ...
        ordered=workload_settings.ordered,
        transactionsenabled=workload_settings.transactionsenabled,
        documentsintransaction=workload_settings.documentsintransaction,
        transactionreadproportion=workload_settings.transactionreadproportion,
        transactionupdateproportion=workload_settings.transactionupdateproportion,
...
def ycsb_mongo_data_load(workload_settings: PhaseSettings,
    ...
    run_mongo_ycsb(
        ...
        journal_ack=workload_settings.mongo_journal_ack,
        read_preference=workload_settings.mongo_read_preference,
        read_concern=workload_settings.mongo_read_concern,
        requestdistribution=workload_settings.requestdistribution,
        ycsb_jvm_args=workload_settings.ycsb_jvm_args,
        timeseries=workload_settings.timeseries,
        phase_params=phase_params,
